...
import PatientVideoCall from "./doctor/pages/PatientVideoCall.jsx";
    ...
    return (
        <div className="space-y-4 sm:space-y-6 lg:space-y-8">
            <section className="rounded-none sm:rounded-3xl bg-gradient-to-b from-blue-50 to-transparent p-3 xs:p-4 sm:p-6 lg:p-8 text-center -mx-2 sm:mx-0 lg:-mx-6 xl:-mx-8 3xl:-mx-12">
                ...
                >
                    <img src="/logo.jpg" alt="App Logo" className="w-full h-full object-contain" />
                </button>
            ...
            <div className="space-y-4 sm:space-y-6">
                <h2 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold tracking-tight text-center lg:text-left">
                    {t('home.services')}
                </h2>
